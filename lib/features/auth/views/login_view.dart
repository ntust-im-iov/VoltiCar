...
class _LoginViewState extends State<LoginView> { // 繼承 State<LoginView>(負責管理 LoginView 的狀態)
  ...
  void _checkLoginStatus() async { // 檢查用戶是否已登入(async 異步處理)
    ...
    final isLoggedIn = await authViewModel.checkLoginStatus(); // await 暫停執行，直到 checkLoginStatus 完成
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OutlinedButton.icon(
                        onPressed: () {
                          authViewModel.signInWithGoogle(); // 呼叫 ViewModel 中的 Google 登入方法
                        },
                        icon: Image.asset(
